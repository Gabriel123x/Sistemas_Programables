...
**R=** Dentro de esta practica realizamos un simple circuito donde un LED oscila entre encendido y apagado, cambiando el valor del potenciometro podemos ajustar que tan frecuente es el parpadeo del LED, dentro del codigo en el metodo "loop" con la funcion "digitalWrite" cambiamos el voltaje de salida del pin digital 13 de 0V a 5V causando que ekl LED se apague o encienda y la manera en que ajustamos la velocidad de oscilacion es con el valor encontrado dentro de la entrada analogica A0 la cual es utilizada con la funcion "delay" para poder ajustar el parpadeo de 0 a 1023 milisegundos. 

![Cap1](../img/test3.4.1.png)  
![Cap2](../img/test3.4.2.png)
