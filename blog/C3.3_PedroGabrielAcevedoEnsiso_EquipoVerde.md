 ...
 **R=** Dentro de esta práctica detectamos el valor del fotoresistor que en este caso seria analogico aunque el fotoresistor se mide en ohm es posible medir su valor utilizando un circuito donde dividamos el voltaje a partir del valor del fotoresistor, el pin A0 mide valores que van desde un rango de 0 a 1023 lo cual con una simple operación la convertimos a voltaje y eso es lo que mostramos en la consola. Conforme cambiamos el calor del fotoresistor vamos elevando la cantidad de voltaje medida. 

![Cap1](../img/test3.3.1.png)  
![Cap2](../img/test3.3.2.png)
